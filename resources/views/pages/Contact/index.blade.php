...
@section('links')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/ThemeStyles/contact_styles.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/ThemeStyles/contact_responsive.css') }}">
@endsection
