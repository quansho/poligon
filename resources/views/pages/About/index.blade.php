...
@section('links')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/ThemeStyles/about_styles.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/ThemeStyles/about_responsive.css') }}">
@endsection
